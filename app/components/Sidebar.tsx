  ...
  return (
    <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
      ...
      <nav className="sidebar-nav" onClick={closeSidebar}>
        ...
        <div className="px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1 mt-6">บริหาร/วางแผนงานก่อสร้าง</div>
        ...
        <div className="px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1 mt-6">ตรวจสอบและเอกสาร</div>
        ...
        <div className="px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1 mt-6">ความปลอดภัย</div>
        ...
        <div className="px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1 mt-6">บุคลากร</div>
        ...
        <div className="px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1 mt-6">ยานพาหนะและเชื้อเพลิง</div>
