              ...
              {reports.length > 0 ? (
                <div id="printable-report">
                  {Array.from({ length: Math.ceil(reports.length / 7) || 1 }).map((_, pageIndex) => {
                    ...
                    return (
                      <div key={pageIndex} className="official-form" style={{ pageBreakAfter: pageIndex < Math.ceil(reports.length / 7) - 1 ? 'always' : 'auto', position: 'relative', height: 'auto', minHeight: '190mm', display: 'flex', flexDirection: 'column' }}>
