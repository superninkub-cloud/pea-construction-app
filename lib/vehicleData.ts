...
export const driversList: VehicleDriver[] = [
  ...
  { plate: "89-5769 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "วีรพัฒน์ นาคลมัย" },
  { plate: "90-1842 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "อุดมศักดิ์ จันทร์กลิ่น" },
  { plate: "90-1843 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "ขวัญนคร ศรีจันทร์อินทร์" },
  { plate: "90-1844 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "ศราวุฒิ เกิดสีเล็ก" },
  { plate: "90-1845 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "ศุภวิชญ์ เกาะลอย" },
  { plate: "90-2228 นฐ", desc: "รถบรรทุก 6 ตัน คิดเครนพับ", driver: "ศุภวิชญ์ เกาะลอย" }
];
