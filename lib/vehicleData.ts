...
export const driversList: VehicleDriver[] = [
  ...
  { plate: "90-2235 นฐ", desc: "รถบรรทุก 6 ตัน ติดเครนพับ", driver: "กิตติภัฏ กาฬษร" },
  { plate: "85-3090 นฐ", desc: "รถเทรลเลอร์", driver: "ธวัชชัย โต๊ะศรีสุข" },
  { plate: "90-2230 นฐ", desc: "รถบรรทุก 6 ตัน ติดเครนพับ", driver: "วิสูตร เสือคล้าย" },
  { plate: "90-2952 นฐ", desc: "รถสว่านขุดเจาะ", driver: "วิสูตร เสือคล้าย" },
  { plate: "90-8896 นฐ", desc: "รถเครนขนาดพิกัด 35 ตัน/เมตร", driver: "เสนาะ ดาวเรือง" },
  { plate: "90-0423 นฐ", desc: "รถบรรทุก 6 ตัน ติดเครนพับ", driver: "โหนก แก้วบัวดี" },
  ...
  { plate: "89-2131 นฐ", desc: "รถบรรทุก 6 ตัน ติดเครนพับ", driver: "พงษ์พันธ์ จุติโรจนปกรณ์" },
  ...
  { plate: "89-5769 นฐ", desc: "รถบรรทุก 3 ตัน", driver: "วีรพัฒน์ นาคลมัย" },
  { plate: "90-1842 นฐ", desc: "รถบรรทุก 4 ตัน", driver: "อุดมศักดิ์ จันทร์กลิ่น" },
  { plate: "90-1843 นฐ", desc: "รถบรรทุก 4 ตัน", driver: "ขวัญนคร ศรีจันทร์อินทร์" },
  { plate: "90-1844 นฐ", desc: "รถบรรทุก 4 ตัน", driver: "ศราวุฒิ เกิดสีเล็ก" },
  { plate: "90-1845 นฐ", desc: "รถบรรทุก 4 ตัน", driver: "ศุภวิชญ์ เกาะลอย" },
  { plate: "90-2228 นฐ", desc: "รถบรรทุก 6 ตัน ติดเครนพับ", driver: "ศุภวิชญ์ เกาะลอย" }
];
