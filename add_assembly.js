...
const newAssembly = {
  "assemblyName": "SS-LA-1 (MP)(ASSEMBLLY NO.5906)",
  "items": [
    ...
    { "code": "1010050010", "name": "PIPE,STEEL,SIZE 20,TYPE 2, 250 mm LONG TIS.277 BUT WITHOUT THREAD", "unit": "ชิ้น", "qty": 1 },
    ...
    { "code": "1020420302", "name": "TERMINAL,COMPRESSION,15 DEGREE PAD,NEMA,4-HOLE,FOR AL. 400 SQ.M", "unit": "ชิ้น", "qty": 6 },
    { "code": "1020430101", "name": "CLAMP,DEAD END,COMPRESSION,DOUBLE LUG,FOR AL.CONDUCTOR 400 S", "unit": "ชุด", "qty": 3 },
    { "code": "1030020101", "name": "INSULATOR,SUSPENSION,COMPOSITE,FOR 115 KV.NOMINAL SELTION LENC", "unit": "ชิ้น", "qty": 6 },
