...
const content = fs.readFileSync('app/gas-report/page.tsx', 'utf-8');

const replacement = `              {reports.length > 0 ? (
...
const startStr = "              {reports.length > 0 ? (";
const endStr = "              ) : (";
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  fs.writeFileSync('app/gas-report/page.tsx', newContent, 'utf-8');
  console.log('Patched');
} else {
