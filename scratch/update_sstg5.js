...
// Find the assembly SS-TG-5 (WITH GROUND PLATE IN POLE)
const targetAssemblyIndex = data.findIndex(a => a.assemblyName.includes('SS-TG-5 (WITH GROUND PLATE IN POLE)'));

const newItems = [
  { "code": "1010000100", "name": "STEEL CHANNEL, 100x50x5 mm. 2,250 MM.LONG", "unit": "ชิ้น", "qty": 6 },
  { "code": "1010010004", "name": "STEEL ANGLE,OVERHEAD GROUND WIRE BAYONET 65X65X6 MM. 2,500 M", "unit": "ชิ้น", "qty": 1 },
...
if (targetAssemblyIndex !== -1) {
  ...
  console.log(`Could not find assembly matching SS-TG-5 (WITH GROUND PLATE IN POLE)`);
}
