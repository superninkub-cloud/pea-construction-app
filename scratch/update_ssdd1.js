...
// Find the assembly SS-DD-1 (MP)
const targetAssemblyIndex = data.findIndex(a => a.assemblyName.includes('SS-DD-1 (MP)') && a.assemblyName.includes('5905'));
...
const newItems = [
  ...
  { "code": "1010150100", "name": "BOLT,OVAL M.20X350 MM.", "unit": "ชุด", "qty": 1 },
  { "code": "1010150101", "name": "BOLT,OVAL M.20X450 MM.", "unit": "ชุด", "qty": 2 },
  { "code": "1010180002", "name": "NET,EYE M.20", "unit": "ชิ้น", "qty": 3 },
  { "code": "1010180100", "name": "WASHER,PLAIN,SQUARE,LARGE 52x52x4.5 mm.HOLE DIA. 18 MM. TIS.258", "unit": "ชิ้น", "qty": 24 },
...
if (targetAssemblyIndex !== -1) {
  ...
  console.log(`Could not find assembly matching SS-DD-1 (MP) 5905`);
}
