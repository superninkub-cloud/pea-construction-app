...
// Find the assembly SS-TG-2(WITH GROUND PLATE IN POLE)
const targetAssemblyIndex = data.findIndex(a => a.assemblyName.includes('SS-TG-2(WITH GROUND PLATE IN POLE)'));
...
if (targetAssemblyIndex !== -1) {
  ...
  console.log(`Could not find assembly matching SS-TG-2(WITH GROUND PLATE IN POLE)`);
}
